...
// You are tasked with creating a basic Node.js server using the

// ```
// http
// ```

// module. The server should be capable of handling two types of requests:
...
// You can choose to implement the file operations (reading and writing) either using the standard Node.js

// ```
// fs
// ```

// (File System) module or by using streams for handling large files more efficiently.
...
const server= http.createServer((req,res)=> {
    if (req.method === 'GET'){
        ...
        return //prevents execution from falling through into success code below it.
        }
